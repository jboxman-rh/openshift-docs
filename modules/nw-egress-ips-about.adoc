...
// Is it worth mentioning that there's also a limit how many MAC addresses
// a NIC on a bare metal cluster can host before performance degrades?
// I wonder if this applies to VMWare?
